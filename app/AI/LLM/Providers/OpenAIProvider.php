...
class OpenAIProvider implements LLMProviderInterface
{
    ...
    {
        $this->apiKey = $apiKey ?? (string) config('ai.providers.openai.key', env('OPENAI_API_KEY', ''));
        $this->baseUrl = rtrim($baseUrl ?? (string) config('ai.providers.openai.url', 'https://api.openai.com/v1'), '/');
