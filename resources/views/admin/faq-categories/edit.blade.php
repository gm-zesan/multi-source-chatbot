                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control custom-input @error('description') is-invalid @enderror" name="description"
                                        id="description" rows="4" placeholder="Optional description">{{ old('description', $category->description) }}</textarea>
                                    @error('description')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="order_column" id="order_column"
                                        value="{{ old('order_column', $category->order_column) }}" min="0">
                                    @error('order_column')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="col-md-4 col-12">
                    <div class="card table-card">
                        ...
                        <div class="custom-form card-body">
                            <button type="submit" class="btn submit-button w-100">Update Category
