                    ...
                    <div class="card table-card">
                        ...
                        <div class="card-body custom-form">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control custom-input @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" placeholder="e.g., Getting Started">
                                        @error('name')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control custom-input @error('icon') is-invalid @enderror" name="icon" id="icon" value="{{ old('icon') }}" placeholder="e.g., heroicon-o-rocket-launch">
                                        @error('icon')
                                            <div class="error_msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control custom-input @error('order_column') is-invalid @enderror" name="order_column" id="order_column" value="{{ old('order_column', 0) }}" min="0">
                                        @error('order_column')
                                            <div class="error_msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control custom-input @error('description') is-invalid @enderror" name="description" id="description" rows="4" placeholder="Optional description">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="error_msg">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-12 mb-2 mb-md-0">
                                        <button type="submit" class="btn submit-button">Save Category
