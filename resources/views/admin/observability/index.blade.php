...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Production system traces, HybridRouter classification distributions, and Tier 4 Answerability Gate decisions.</p>
        </div>
        <div class="d-flex align-items-center gap-2">
            <span class="badge" style="background: #f0fdf4; color: #15803d; border: 1px solid #bbf7d0; padding: 6px 12px; font-size: 12px;">
        ...
        <div class="col-xl-3 col-md-6 col-12">
            <div class="kpi-card d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="kpi-val">{{ $p50Latency }} <span style="font-size: 14px; font-weight: 500; color: #64748b;">ms</span></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-12">
            <div class="kpi-card d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="kpi-val">{{ $p95Latency }} <span style="font-size: 14px; font-weight: 500; color: #64748b;">ms</span></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-12">
            ...
            <div class="dist-card">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $routeCounts['knowledge'] }} ({{ round(($routeCounts['knowledge'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $routeCounts['chat'] }} ({{ round(($routeCounts['chat'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" style="width: {{ ($routeCounts['chat'] / $totalRoutes) * 100 }}%; background-color: #4f46e5;"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $routeCounts['action'] }} ({{ round(($routeCounts['action'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" style="width: {{ ($routeCounts['action'] / $totalRoutes) * 100 }}%; background-color: #7c3aed;"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $routeCounts['ood'] }} ({{ round(($routeCounts['ood'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                ...
                <div>
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $routeCounts['uncertain'] }} ({{ round(($routeCounts['uncertain'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
            ...
            <div class="dist-card">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $gateCounts['confident'] }} ({{ round(($gateCounts['confident'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        <span><strong class="text-warning text-dark">AMBIGUOUS</strong> (Clarification & Multi-Option)</span>
                        <span>{{ $gateCounts['ambiguous'] }} ({{ round(($gateCounts['ambiguous'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $gateCounts['unanswerable'] }} ({{ round(($gateCounts['unanswerable'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
                ...
                <div>
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span>{{ $gateCounts['bypassed'] }} ({{ round(($gateCounts['bypassed'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 8px;">
        ...
        <div class="modal-content">
            <div class="modal-header bg-dark text-white">
                <h6 class="modal-title mb-0" id="traceModalLabel">
                    <i class="ri-file-search-line me-1 text-info"></i> Pipeline Telemetry Trace (<span id="modalMsgId"></span>)
                </h6>
            ...
            <div class="modal-body p-3">
                <div class="mb-3">
                    ...
                    <div class="p-3" style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; font-size: 13px;" id="modalReplyText">
                    </div>
                </div>
