    ...
    <div class="card table-card mb-4">
        <div class="card-header table-header">
            ...
            <div class="d-flex align-items-center gap-2">
                <span class="badge" style="background: #f0fdf4; color: #166534; border: 1px solid #bbf7d0; padding: 6px 12px; font-weight: 500; font-size: 12px;">
        ...
        <div class="col-xl-3 col-md-6 col-12">
            <div class="kpi-card d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="kpi-val">{{ $p50Latency }} <span style="font-size: 13px; font-weight: 500; color: #64748b;">ms</span></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-12">
            <div class="kpi-card d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="kpi-val">{{ $p95Latency }} <span style="font-size: 13px; font-weight: 500; color: #64748b;">ms</span></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-12">
            ...
            <div class="dist-card">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $routeCounts['knowledge'] }} ({{ round(($routeCounts['knowledge'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-primary" style="width: {{ ($routeCounts['knowledge'] / $totalRoutes) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $routeCounts['chat'] }} ({{ round(($routeCounts['chat'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar" style="width: {{ ($routeCounts['chat'] / $totalRoutes) * 100 }}%; background-color: #6d28d9;"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $routeCounts['action'] }} ({{ round(($routeCounts['action'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar" style="width: {{ ($routeCounts['action'] / $totalRoutes) * 100 }}%; background-color: #0f766e;"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $routeCounts['ood'] }} ({{ round(($routeCounts['ood'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-danger" style="width: {{ ($routeCounts['ood'] / $totalRoutes) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $routeCounts['uncertain'] }} ({{ round(($routeCounts['uncertain'] / $totalRoutes) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-warning" style="width: {{ ($routeCounts['uncertain'] / $totalRoutes) * 100 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="dist-card">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $gateCounts['confident'] }} ({{ round(($gateCounts['confident'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-success" style="width: {{ ($gateCounts['confident'] / $totalGates) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $gateCounts['ambiguous'] }} ({{ round(($gateCounts['ambiguous'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-warning" style="width: {{ ($gateCounts['ambiguous'] / $totalGates) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $gateCounts['unanswerable'] }} ({{ round(($gateCounts['unanswerable'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-danger" style="width: {{ ($gateCounts['unanswerable'] / $totalGates) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="text-muted">{{ $gateCounts['bypassed'] }} ({{ round(($gateCounts['bypassed'] / $totalGates) * 100, 1) }}%)</span>
                    </div>
                    <div class="progress" style="height: 6px;">
                        <div class="progress-bar bg-secondary" style="width: {{ ($gateCounts['bypassed'] / $totalGates) * 100 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($messages as $index => $msg)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('conversations.show', $msg->conversation_id) }}" class="fw-medium text-decoration-none">
                                    ...
                                    <td class="text-end">
                                        <button type="button" class="btn btn-sm btn-outline-primary p-1" title="Inspect Trace"
        ...
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2">
                            <h6 class="modal-title fw-bold mb-0 text-dark" id="traceModalLabel">Turn Diagnostic Telemetry</h6>
                            <span class="badge" style="background: #f1f5f9; color: #475569; border: 1px solid #e2e8f0; font-family: monospace; font-size: 11px;">#<span id="modalMsgId">-</span></span>
                        </div>
                        <small class="text-muted">Live pipeline routing, answerability verification, and token metrics</small>
                    </div>
                </div>
            ...
            <div class="modal-body p-4">
                ...
                <ul class="nav nav-pills mb-3" id="traceModalTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pill-overview-tab" data-bs-toggle="pill" data-bs-target="#pill-overview" type="button" role="tab">
                            <i class="ri-dashboard-line me-1"></i> Structured Overview
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pill-json-tab" data-bs-toggle="pill" data-bs-target="#pill-json" type="button" role="tab">
                ...
                <div class="tab-content" id="traceModalTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="pill-overview" role="tabpanel">
                        ...
                        <div class="response-card mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="small fw-semibold text-uppercase text-muted" style="letter-spacing: 0.5px;">AI Generated Outbound Response</span>
                                <button type="button" class="btn btn-sm btn-outline-secondary py-0 px-2" id="btnCopyReply" onclick="copyModalReplyText()">
                                    <i class="ri-file-copy-line me-1"></i> <span id="copyReplyLabel">Copy</span>
                                </button>
                            </div>
                            <div id="modalReplyText" class="text-dark small" style="white-space: pre-wrap; line-height: 1.6;"></div>
                        </div>

                        {{-- Grounding & Knowledge Context --}}
                        <div id="modalGroundingSection" class="grounding-card mb-3 d-none">
                            <div class="small fw-semibold text-uppercase text-muted mb-2" style="letter-spacing: 0.5px;">
                    ...
                    <div class="tab-pane fade" id="pill-json" role="tabpanel">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary py-0 px-2" id="btnCopyJson" onclick="copyModalJsonPayload()">
